...
class Authenticate:
    ...
    def _register_credentials(self, email: str, name: str, password: str, preauthorization: bool, needs: bool=False, postal_code: str=None):
        ...
        client.close()
        # try:
        #     self.mailchimp_client.lists.members.create(os.environ['MAILCHIMP_LIST_ID'], {
        #             'email_address': email,
        #             'status': 'subscribed',
        #             'merge_fields': {
        #                 'FNAME': name,  # This assumes you have a 'FNAME' merge field in your MailChimp list
        #             },
        #         })
        ...
        # Call FastAPI email verification service after successfully adding to users and Mailchimp list
        verification_url = "https://fastapi-production-86e9.up.railway.app/send_verification"
