...
st.set_page_config(page_title="SmartRealtor.ai", page_icon=":house", layout="centered", initial_sidebar_state="auto", menu_items=None)
...
if __name__ == "__main__":
    st.session_state['authenticator'] = Authenticate("smartrealtorcookie3124", "smartrealtorkey3214", 30)
