...
def send_email(subject, message, to_address, tenant_name, tenant_address, attachment_path=None):
    ...
    from_address = 'pratikabnave97@gmail.com'
    ...
    # Add an advertisement for smartrealtor.ai with hyperlink
    ad_message = """
    <br><br>
    ---
    <br>
    Check out <a href="https://app.smartrealtor.ai/">SmartRealtor.ai</a> - Your go-to real estate pricing application! Discover the best pricing strategies, get insights on market trends, and much more. Click <a href="https://app.smartrealtor.ai/">here</a> to explore.
    """
    ...
    text = msg.as_string()
    recipients = [to_address, 'pratikabnave@gmail.com']  # Include BCC recipient in the recipients list
...
def create_pdf_with_textual_data(data, filename):
    ...
    # Add a subtitle indicating the report was generated by smartrealtor.ai
    subtitle = Paragraph("Generated by <a href='https://SmartRealtor.ai/' color='blue'>SmartRealtor.ai</a> on behalf of the tenant", styles['Centered'])
...
def main():
    ...
    st.markdown('### Powered by [Pratik Abnave](https://pratik97.pythonanywhere.com)')
